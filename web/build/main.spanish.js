...
function setFrameReady(iframeName) {
    $.frameReady(function () {
        $(document).ready(function () {
            $('video:not(.skip), audio:not(.skip)').mediaelementplayer({
                pluginPath: 'http://localhost/chamilo/web/assets/mediaelement/build/',
                //renderers: ['html5', 'flash_video', 'native_flv'],
                features: ['playpause','current','progress','duration','tracks','volume','fullscreen','vrview'],
                success: function(mediaElement, originalNode, instance) {
                },
                vrPath: 'http://localhost/chamilo/web/assets/vrview/build/vrview.js'
            });
        });
    }, 'top.' + iframeName, {
        load: [
            {type: 'script', id: '_fr1', src: 'http://localhost/chamilo/web/assets/jquery/dist/jquery.min.js'},
            {type: 'script', id: '_fr7', src: 'http://localhost/chamilo/web/assets/MathJax/MathJax.js?config=AM_HTMLorMML'},
            {type: 'script', id: '_fr4', src: 'http://localhost/chamilo/web/assets/jquery-ui/jquery-ui.min.js'},
            {type: 'stylesheet', id: '_fr5', src: 'http://localhost/chamilo/web/assets/jquery-ui/themes/smoothness/jquery-ui.min.css'},
            {type: 'stylesheet', id: '_fr6', src: 'http://localhost/chamilo/web/assets/jquery-ui/themes/smoothness/theme.css'},
            {type: 'script', id: '_fr2', src: 'http://localhost/chamilo/main/inc/lib/javascript/jquery.highlight.js'},
            {type: 'script', id: '_fr3', src: 'http://localhost/chamilo/main/glossary/glossary.js.php?'},
            {type: 'script', id: '_media1', src: 'http://localhost/chamilo/web/assets/mediaelement/build/mediaelement-and-player.min.js'},
            {type: 'stylesheet', id: '_media2', src: 'http://localhost/chamilo/web/assets/mediaelement/build/mediaelementplayer.min.css'},
                        {type: 'stylesheet', id: '_media4', src: 'http://localhost/chamilo/web/assets/mediaelement/plugins/vrview/vrview.css'},
            {type: 'script', id: '_media4', src: 'http://localhost/chamilo/web/assets/mediaelement/plugins/vrview/vrview.js'},
        ]
    });
}